...
# Create nsg-01 rules allow SSH|HTTP from Anywhere
az network nsg rule create --resource-group $rg --nsg-name cake-spoke1-nsg-01 --name allowAll --priority 110 --destination-port-ranges '*' --source-address-prefixes '*' --access Allow --protocol '*'
...
# Create nsg-01 rules allow SSH|HTTP from Anywhere
az network nsg rule create --resource-group $rg --nsg-name cake-spoke2-nsg-01 --name allowAll --priority 110 --destination-port-ranges '*' --source-address-prefixes '*' --access Allow --protocol '*'
