...
az vm create --resource-group $rg --name "cake-hub-vm-01" --location $location --vnet-name "cake-hub-vnet-01" --subnet "hub-subnet-01" --image Ubuntu2204 --public-ip-sku "Basic" --admin-username azureuser --generate-ssh-keys
